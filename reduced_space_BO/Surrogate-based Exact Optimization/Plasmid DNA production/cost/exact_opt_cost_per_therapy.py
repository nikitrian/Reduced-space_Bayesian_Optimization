...
space = [
    ...
    #{'name': 'seed_conversion', 'type': 'continuous', 'domain': (0.*0.9, 0.98*1.1)},
...
ANN_path = 'ann_ACC_0.18_11940_0.0001_512_1.pkl'
...
# Convert input_bounds2 to the format of input_bounds
...
# Constraints
model.con = pyo.Constraint(expr=model.nn.inputs[0] <= model.nn.inputs[2])
