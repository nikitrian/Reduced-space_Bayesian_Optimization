...
ANN_PKL_PATH     = os.path.join(BASE_DIR, "ann_ACC_0.35_5884_0.0020_512_1.pkl")
...
def superpro_sim_hi(X01: torch.Tensor) -> torch.Tensor:
    ...
    try:
        ...
        for i in range(X_real.shape[0]):
            ...
            temp4 = excel.Application.Run('SuperExcelMatlab', 43200, p[0], 0.0033, 
                                            0.02045, 0.95, p[1], p[2], p[3], 
                                            0.98, 150, p[4], 0.03, np.round(p[5]), 
                                            p[6], 0.02, np.round(40), 0.001333, 0.05)  
