...
ANN_PKL_PATH     = os.path.join(BASE_DIR, "ann_ACC_0.19_24480_0.0000_437_1.pkl")
    ...
    try:
        ...
        for i in range(X_real.shape[0]):
            ...
            temp4 = excel.Application.Run(
                'SuperExcelMatlab',
                43200, 108000, 0.0033, p[0], 0.95,
                144000, p[1], p[2], p[3], 150,
                p[4], 0.03, np.round(p[5]), 0.003, 0.02,
                np.round(p[6]), p[7], 0.05
            )
